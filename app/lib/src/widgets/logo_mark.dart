...
class _LogoMarkPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // `M8.8 16 L8.8 8.8 L12 12.4 L15.2 8.8 L15.2 16` — the "M" glyph,
    // gradient stroke per `<linearGradient id="g" x1="8.8" y1="8.8"
    // x2="15.2" y2="16">`.
    final gradientPaint = Paint()
      ...
      ..strokeCap = StrokeCap.round
      ..strokeJoin = StrokeJoin.round
      ..shader = const LinearGradient(colors: [_gradientStart, _gradientEnd])
          .createShader(
            Rect.fromPoints(
